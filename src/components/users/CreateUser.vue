    ...
    <div class="form-blog">
        ...
        <form class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <input type="file" class="form-control" id="avatar" @blur="validate()">
            ...
            <div class="col-12 btn-style">
                <button @click.prevent="save()" type="submit" class="btn btn-primary">Lưu lại</button>
                <button @click.prevent="clearValue()" type="submit" class="btn btn-danger">Huỷ bỏ</button>
            </div>
        </form>
    </div>
</template>
